...
- M1: branch feature/spec-001/view-business-profile created and repo ready to add frontend/
...
- Branch names MUST start with `feature/`, include the spec ID, and follow `feature/spec-###/t###-short-task-slug`.
...
- [X] T001 Scaffold Vite + React 19 + TypeScript app (frontend/package.json, frontend/vite.config.ts, frontend/src/main.tsx)
  ...
  - Branch: feature/spec-001/t001-scaffold-and-branch-policy
...
- [X] T003 [P] Add Profile Zod schema and fixture validation (frontend/src/domain/profileSchema.ts)
  ...
  - Branch: feature/spec-001/t003-profile-schema-fixture-validation
...
- [X] T004 [P] Add design tokens, CSS Modules baseline, and responsive layout primitives (frontend/src/styles/tokens.css, frontend/src/styles/globals.module.css)
  - Owner: @dev | Estimate: 0.5d | Depends: T001
  - Branch: feature/spec-001/t004-design-tokens-responsive-css
...
- [X] T005 Implement ProfileContext + reducer for profile, draft, preview, collapse, undo, and current role (frontend/src/context/ProfileContext.tsx)
  ...
  - Branch: feature/spec-001/t005-profile-context-reducer
